...
import Mantra from "../assets/mantra_article_image.webp"
import Ayurvedic from "../assets/ayurvedic_article_image.webp"
            ...
            <section>
                ...
                <div className='festival_optiopns'>
                    ...
                    <div className='festival_cont'>
                        ...
                        <div className='text_cont'>
                            <h3>Mantra</h3>
                            <p>Here you will find all the powerful mantras for peace of mind. Chant these mantras and remove all the obstacles from life.</p>
                            <button className='btn'>Read All</button>
                        </div>
                    </div>
                    <div className='festival_cont'>
                        ...
                        <div className='text_cont'>
                            <h3>Ayurvedic & Home Remedies</h3>
                            <p>We have brought the precious knowledge of Ayurveda for you, these remedies will help you lead a healthy life.</p>
                            <button className='btn'>Read All</button>
                        </div>
                    </div>
                </div>
