    ...
    return (
        <Menu>
            ...
            <div>
                ...
                <MenuItem><img src={History} alt="" /> My Ramotsav Bookings <span className='arrow'><img src={Arrow} alt="" /></span></MenuItem>
                <MenuItem><img src={Server} alt="" /> Book a Puja <NewLabel>New</NewLabel> <span className='arrow'><img src={Arrow} alt="" /></span></MenuItem>
            </div>
            <Divider />
            <Support>
                <SupportItem>
                    ...
                    <div className='contact'>
                        <SupportDetails><img src={Phone} alt="" /> 080-711-74417</SupportDetails>
                        <p className='timing'>You can call us from 10:30 AM - 7:30 PM</p>
                    </div>
                   <div className='social_icon'>
                        <div><img src={Gmail} alt=""/> Email us</div>
