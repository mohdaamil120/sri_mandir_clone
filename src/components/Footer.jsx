...
import Digital from "../assets/digitalindia.svg";
import StartupInd from "../assets/startupindia.svg";
import Azadi from "../assets/azadi75.svg";
    ...
    <div className='main'>
        <footer>
            ...
            <div className='below_cont'>
                <div className='below_img_cont'>
                    <img src={Digital} alt='logo' />
                    <img src={StartupInd} alt='logo' />
                    <img src={Azadi} alt='logo' />
                </div>
